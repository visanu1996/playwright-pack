...
class TestCart:
    ...
    def test_remove_item_from_cart(self):
        ...
        self.sauce_common.cart_page.remove_products(['Backpack', 'T-Shirt'])
    
    def test_commit_purchases(self):
        """ TC003 Continue shoping then add new items and commit purchase """
        self.sauce_common.cart_page.back_to_shopping()
        self.sauce_common.product_page.add_or_remove_products(['Onesie'])
        self.sauce_common.cart_page.goto_page("cart")
        self.sauce_common.cart_page.verify_items_in_cart(['Backpack','Bike Light', 'T-Shirt', 'Onesie'])
